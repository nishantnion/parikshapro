...
const seed = async () => {
  ...
  try {
    ...
    const categories = [
      { id: 'jee', name: 'JEE Main', name_hi: 'जेईई मेन', icon: '⚙️', color: '#f7b731', subject: 'Engineering', sections_config: [{ name: 'Physics', count: 25 }, { name: 'Chemistry', count: 25 }, { name: 'Mathematics', count: 25 }], total_questions: 75, duration_minutes: 180, marking_scheme: { correct: 4, wrong: -1 } },
      { id: 'neet', name: 'NEET UG', name_hi: 'नीट यूजी', icon: '⚕️', color: '#00d4aa', subject: 'Medical', sections_config: [{ name: 'Physics', count: 45 }, { name: 'Chemistry', count: 45 }, { name: 'Biology', count: 90 }], total_questions: 180, duration_minutes: 200, marking_scheme: { correct: 4, wrong: -1 } },
      { id: 'upsc', name: 'UPSC CSE', name_hi: 'यूपीएससी सीएसई', icon: '🏛️', color: '#a855f7', subject: 'Civil Services', sections_config: [{ name: 'General Studies', count: 50 }, { name: 'CSAT', count: 30 }], total_questions: 80, duration_minutes: 120, marking_scheme: { correct: 2, wrong: -0.67 } },
      { id: 'ibps', name: 'IBPS PO', name_hi: 'आईबीपीएस पीओ', icon: '🏦', color: '#3b82f6', subject: 'Banking', sections_config: [{ name: 'Reasoning', count: 35 }, { name: 'Quantitative Aptitude', count: 35 }, { name: 'English Language', count: 30 }], total_questions: 100, duration_minutes: 60, marking_scheme: { correct: 1, wrong: -0.25 } },
      { id: 'ssc', name: 'SSC CGL', name_hi: 'एसएससी सीजीएल', icon: '📋', color: '#ff6b35', subject: 'SSC', sections_config: [{ name: 'General Intelligence', count: 25 }, { name: 'General Awareness', count: 25 }, { name: 'Quantitative Aptitude', count: 25 }, { name: 'English Comprehension', count: 25 }], total_questions: 100, duration_minutes: 60, marking_scheme: { correct: 2, wrong: -0.5 } },
      { id: 'gate', name: 'GATE CS', name_hi: 'गेट सीएस', icon: '💻', color: '#06b6d4', subject: 'IT Sector', sections_config: [{ name: 'General Aptitude', count: 10 }, { name: 'Core CS', count: 55 }], total_questions: 65, duration_minutes: 180, marking_scheme: { correct: 1, wrong: -0.33 } },
      { id: 'nda', name: 'NDA', name_hi: 'एनडीए', icon: '⚔️', color: '#ef4444', subject: 'Defence', sections_config: [{ name: 'Mathematics', count: 120 }, { name: 'General Ability', count: 150 }], total_questions: 270, duration_minutes: 150, marking_scheme: { correct: 2.5, wrong: -0.83 } },
      { id: 'rrb', name: 'RRB NTPC', name_hi: 'आरआरबी एनटीपीसी', icon: '🚂', color: '#f97316', subject: 'Railways', sections_config: [{ name: 'Mathematics', count: 30 }, { name: 'General Intelligence', count: 30 }, { name: 'General Awareness', count: 40 }], total_questions: 100, duration_minutes: 90, marking_scheme: { correct: 1, wrong: -0.33 } },
    ];
